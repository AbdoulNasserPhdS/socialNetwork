<template>
  ...
  <div
    class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-700 py-6 sm:py-12"
  >
    <div class="mx-auto max-w-screen-xl px-4 w-full">
      <!-- Section Amis -->
      <div class="h-screen">
        <h2 v-if="friends" class="mb-4 font-bold text-2xl text-gray-100 hidden md:block">
          Friends
        </h2>
      ...
      <div class="mt-12">
        <h2 v-if="friendshipRequests" class="mb-4 font-bold text-2xl text-gray-100">
          Friends Request
        </h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
