...
<template>
    ...
    <form v-on:submit.prevent="submitForm">
        ...
        xl:px-5 lg:flex-row">
                <div class="flex flex-col items-center w-full  pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
                ...
                relative z-10">
                    ...
                    absolute">Username</p>
                                    <input placeholder="John" type="text" v-model="form.name" class="border placeholder-gray-400 focus:outline-none
                    ...
                    border-gray-300 rounded-md" />
                                ...
                                <div class="relative">
                                    <p
                                        ...
                                        Email</p>
                                    <input placeholder="123@ex.com" type="text" v-model="form.email" class="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md" />
                                </div>
                                <div class="relative">
                                    <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                    absolute">Password</p>
                                    <input placeholder="Password" type="password" v-model="form.password1" class="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md" />
                                </div>
                                ...
                                <div class="relative">
                                    <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                    absolute">Repeat Password</p>
                                    <input placeholder="Password" type="password" v-model="form.password2" class="border placeholder-gray-400 focus:outline-none
                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                    border-gray-300 rounded-md" />
                                </div>
                ...
                axios
                    ...
                    .then(response => {
                        if (response.data.message === 'success') {
                            ...
                            console.log('succeful subscribe')
